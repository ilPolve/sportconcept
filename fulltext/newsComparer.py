...
def test_single_comparer(concepts_A, news_A, concepts_B, news_B):
    ...
    return test_comparison_object_constructor(len(simil_concepts), cosine=False, max_news_len=(len(concepts_A) + len(concepts_B))/2)
...
def test_comparison_object_constructor(simil_concepts_length, cosine= False, max_news_len= 0):
    to_ret= {}
