...
def sce_visual():
    ...
    skipped = {"DE\\Spiegel": [], "EN\\BBC": [], "ES\\ABC": [], "FR\\France24": [], "IT\\ilPost": []}
    common =  {"DE\\Spiegel": [], "EN\\BBC": [], "ES\\ABC": [], "FR\\France24": [], "IT\\ilPost": []}
    exclusive =  {"DE\\Spiegel": [], "EN\\BBC": [], "ES\\ABC": [], "FR\\France24": [], "IT\\ilPost": []}
    for key in skipped:
    ...
    for key in skipped:
        plt.plot(sorted_data, skipped[key], label="Skipped")
        plt.plot(sorted_data, common[key], label="Common")
        plt.plot(sorted_data, exclusive[key], label="Exclusive")
